export const myLinks = [
    {
        ...
        type: 'social',
        src: 'src/lib/images/linkedin-logo.svg',
        title: 'LinkedIn'
    }, {
        id: 'instagram',
        url: 'https://www.instagram.com/shanfan.huang',
        type: 'social',
        src: 'src/lib/images/instagram-logo.svg',
        title: 'Instagram'
    }, {
        id: 'bluesky',
        url: 'https://bsky.app/profile/shanfan.bsky.social',
        type: 'social',
        src: 'src/lib/images/bluesky-logo.svg',
        title: 'Blue Sky'
    }, {
        id: 'newsletter',
        url: 'https://picturetextandnumbers.substack.com',
        type: 'creative',
        src: 'src/lib/images/substack-logo.svg',
        title: 'Newsletter'
    }, {
        id: 'behance',
        url: 'https://www.behance.net/shanfanhuang',
        type: 'creative',
        src: 'src/lib/images/behance-logo.svg',
        title: 'Visual Design'
    }, {
        id: 'github',
        url: 'https://shanfan.github.io/',
        type: 'creative',
        src: 'src/lib/images/github-logo.svg',
        title: 'Coding'
    }
];